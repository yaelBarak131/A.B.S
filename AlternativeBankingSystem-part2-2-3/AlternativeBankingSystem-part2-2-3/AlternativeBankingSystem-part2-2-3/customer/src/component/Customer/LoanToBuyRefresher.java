...
public class LoanToBuyRefresher extends TimerTask {
  ...
  //todo 14/7
    ...
    public LoanToBuyRefresher(String userName, Consumer<LoansOnSell> loansConsumer, Consumer<String> onFail, BooleanProperty rewindMode, IntegerProperty currYaz) {
    ...
    public void run() {
        ...
        String finalUrl = HttpUrl
                .parse(Constants.GET_LOANS_TO_BUY)
                .newBuilder()
