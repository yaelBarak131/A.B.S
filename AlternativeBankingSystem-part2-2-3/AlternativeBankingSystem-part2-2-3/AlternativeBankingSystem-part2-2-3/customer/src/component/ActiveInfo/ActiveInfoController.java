...
import component.RiskInfo.PaymentInfo.PaymentInfoController;
...
public class ActiveInfoController {
    ...
    public void addInformationToLists(PopOver pendingInfo, String nextYaz, String activeYaz, PrintPayments payments){
        ...
        paymentScrollPane = createPaymentTail(payments);
    }
    private ScrollPane createPaymentTail(PrintPayments payments){
        try {
    ...
    public VBox createPaymentTail(PrintPayment payment){
        ...
        URL mainFXML = getClass().getResource("/components/PaymentInfo/paymentInfo.fxml");
        loader.setLocation(mainFXML);
